                    ...
                    <div class="services-thumb section-bg mb-lg-0">
                        <div class="row">
                            <div class="col-lg-5 col-md-5 col-12">
                                <div class="services-image-wrap">
                                    <a href="services-detail.html">
                                        <img src="{{ asset('/storage/'.$paket->gambar) }}" class="services-image img-fluid" alt="">
                                        <img src="{{ asset('/storage/'.$paket->gambar) }}" class="services-image services-image-hover img-fluid" alt="">
                            ...
                            <div class="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                <div class="services-info mt-4 mt-lg-0 mt-md-0 d-flex w-100" style="flex-direction: column">
                                    <h4 class="services-title mb-1 mb-lg-2">
                                        <a class="services-title-link" href="services-detail.html">{{ $paket->nama_paket }}</a>
                                    </h4>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="input-group">
                                            <span class="input-group-btn dash" data-id='{{ $paket->id }}'>
                                                <button type="button" class="btn btn-danger btn-number dash" data-id='{{ $paket->id }}' data-type="minus" data-field="quant[2]">
