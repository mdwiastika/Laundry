   ...
   <body>
       ...
       <form action="{{ route('post-register') }}" method="POST">
           ...
           <input required type="text" placeholder="Masukkan Nama" name="nama" id="nama">

           <label for="email">Email</label>
           <input required type="email" placeholder="Masukkan Email" name="email" id="email">
           ...
           <div class="social">
               <a href="{{ route('login') }}">Sudah punya akun? Klik di sini</a>
           </div>
       </form>
   </body>
