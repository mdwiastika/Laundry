                    ...
                    <form>
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input disabled value="{{ $outlet->nama }}" required class="form-control" required type="text" placeholder="Masukkan Nama"
                                    name="nama" id="nama">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input disabled value="{{ $outlet->tlp }}" required class="form-control" required type="text" placeholder="Masukkan Telepon"
                                    name="tlp" id="tlp">
                            </div>
